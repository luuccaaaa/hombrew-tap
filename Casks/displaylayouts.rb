 cask "displaylayouts" do
    ...
    url "https://github.com/luuccaaaa/DisplayLayoutsApp/releases/download/v#{version}/DisplayLayouts-#{version}.dmg",
    verified: "github.com/luuccaaaa/DisplayLayoutsApp/"
    name "DisplayLayouts"
    desc "Menu bar app to switch multi-monitor layouts"
    homepage "https://github.com/luuccaaaa/DisplayLayoutsApp"
